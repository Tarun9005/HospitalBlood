...
<body>
    <div class="content">
        ...
        <div class="loginForm">
            <h1 class="formtitle">Login for Receivers</h1>
            <form action="./validationreceivers.php" method="POST">
                <div class="inputtype">
                ...
                <h6 class= "signupText"><a href="./signup.php">Create a new account for receiver?</a></h6>
